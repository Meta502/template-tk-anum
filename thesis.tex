...
Jika diperhatikan, fungsi tersebut memang hanya merupakan translasi dari rumus yang sudah diberikan. Namun, digunakan pendekatan \emph{ceil((b-a)/tolˆ(1/4))} sebagai nilai partisi komposit.
% gimana jelasin si + 4*f(a+h*(2*i-1)) + 2*f(a+h*2*i) nya ya ...
