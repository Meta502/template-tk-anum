...
\begin{enumerate}
	...
	\item
	      ...
	      Solusi Adaptive Quadrature menggunakan ekstrapolasi dengan melalui pendekatan dengan pembagian subinterval, hal ini menyebabkan pemilihan \emph{criteria step-size} dilakukan bersamaan dengan kalkulasi yang sesuai. Pada penelitian ini penulis akan menggunakan Adaptive Quadrature Trapezodial sebagai berikut:
...
Di sini, terdapat 11 FLOPs yang terjadi; 7 FLOPs pada inisiasi variabel \emph{n} (operasi pangkat dihitung 4 FLOPs), 2 FLOPs pada inisiasi variabel \emph{h}, 1 FLOP pada inisiasi variabel \emph{res}, dan 2 FLOPs pada pemastian variabel \emph{n} bernilai genap.
