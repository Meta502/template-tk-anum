...
\lstinputlisting{assets/codes/getSplineCoeff.m}
Asumsikan bahwa \(n\) adalah jumlah pasangan \(x, y\) yang dimasukkan ke fungsi. Parhatikan bahwa pada fungsi yang membuat matriks persamaan, terdapat pemanggilan \emph{floating point operation} sebanyak:
\begin{equation}
...
\subsection{Kompleksitas Parametric Spline}
